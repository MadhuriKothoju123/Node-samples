...
describe("Library Controller", () => {
  ...
  it("should render edit mode when bookId is provided", async () => {
    ...
    res.render = jest.fn(); // Mock render method
  ...
  it("should return all books", async () => {
    const req = mockRequest({ flash: jest.fn(),});
    const res = mockResponse();
  ...
  it("should delete a book and associated files", async () => {
    const req = mockRequest({ params: { bookId: "123" } ,  flash: jest.fn(),});
    const res = mockResponse();
  ...
  it("should handle invalid book ID", async () => {
    const req = mockRequest({ params: { bookId: "invalid" },  flash: jest.fn(), });
    const res = mockResponse();
